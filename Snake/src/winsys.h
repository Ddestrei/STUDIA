...
/// Klasa ta zawiera prostokąt w kutórym to okno występuje
class CView
{
protected:
	CRect geom;
...
{
public:
	CFramedWindow(CRect r, char _c = 'a') : CWindow(r, _c) {}
	/// Odpowiada za narysowanie obramówki 
	void paint();
};
...
class CInputLine:public CFramedWindow
{
   string text;
public:
  ///  drugi argomet określa wypełnienie 
